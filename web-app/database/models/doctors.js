...
doctorSchema.statics.saltAndHashPassword = async function (password) {
...
doctorSchema.statics.validateByCredentials = function (email, password) {
    let User = this;
...
doctors.createIndexes();  //idempotent operation. Only called once.  (Calling createIndex manually like this is perfectly fine if autoIndex is turned off)
