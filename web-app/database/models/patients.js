...
patientSchema.statics.saltAndHashPassword = async function (password) {
...
patientSchema.statics.validateByCredentials = function (email, password) {
    let User = this;
